var oneone = Mario.oneone = function() {
  ...
  level = new Mario.Level({
    ...
    exit: 204,
    floorSprite:  new Mario.Sprite('sprites/tiles_lulu.png', [0,0],[16,16],0),
    cloudSprite:  new Mario.Sprite('sprites/tiles_lulu.png', [0,320],[48,32],0),
    wallSprite: new Mario.Sprite('sprites/tiles_lulu.png', [0, 16],[16,16],0),
    brickSprite: new Mario.Sprite('sprites/tiles_lulu.png', [16, 0], [16,16], 0),
    brickBounceSprite: new Mario.Sprite('sprites/tiles_lulu.png',[32,0],[16,16],0),
    rubbleSprite: function () {
      return new Mario.Sprite('sprites/items_lulu.png', [64,0], [8,8], 3, [0,1])
    },
    ublockSprite: new Mario.Sprite('sprites/tiles_lulu.png', [48, 0], [16,16],0),
    superShroomSprite: new Mario.Sprite('sprites/items_lulu.png', [0,0], [16,16], 0),
    fireFlowerSprite: new Mario.Sprite('sprites/items_lulu.png', [0,32], [16,16], 20, [0,1,2,3]),
    starSprite: new Mario.Sprite('sprites/items_lulu.png', [0,48], [16,16], 20, [0,1,2,3]),
    pipeLEndSprite: new Mario.Sprite('sprites/tiles_lulu.png', [0, 128], [16,16], 0),
    pipeREndSprite: new Mario.Sprite('sprites/tiles_lulu.png', [16, 128], [16,16], 0),
    pipeLMidSprite: new Mario.Sprite('sprites/tiles_lulu.png', [0, 144], [16,16], 0),
    pipeRMidSprite: new Mario.Sprite('sprites/tiles_lulu.png', [16, 144], [16,16], 0),

    pipeUpMid: new Mario.Sprite('sprites/tiles_lulu.png', [0, 144], [32,16], 0),
    pipeSideMid: new Mario.Sprite('sprites/tiles_lulu.png', [48, 128], [16,32], 0),
    pipeLeft: new Mario.Sprite('sprites/tiles_lulu.png', [32, 128], [16,32], 0),
    pipeTop: new Mario.Sprite('sprites/tiles_lulu.png', [0, 128], [32,16], 0),
    qblockSprite: new Mario.Sprite('sprites/tiles_lulu.png', [384, 0], [16,16], 8, [0,0,0,0,1,2,1]),
    bcoinSprite: function() {
      return new Mario.Sprite('sprites/items_lulu.png', [0,112],[16,16], 20,[0,1,2,3]);
    },
    cloudSprites:[
      new Mario.Sprite('sprites/tiles_lulu.png', [0,320],[16,32],0),
      new Mario.Sprite('sprites/tiles_lulu.png', [16,320],[16,32],0),
      new Mario.Sprite('sprites/tiles_lulu.png', [32,320],[16,32],0)
    ],
    hillSprites: [
      new Mario.Sprite('sprites/tiles_lulu.png', [128,128],[16,16],0),
      new Mario.Sprite('sprites/tiles_lulu.png', [144,128],[16,16],0),
      new Mario.Sprite('sprites/tiles_lulu.png', [160,128],[16,16],0),
      new Mario.Sprite('sprites/tiles_lulu.png', [128,144],[16,16],0),
      new Mario.Sprite('sprites/tiles_lulu.png', [144,144],[16,16],0),
      new Mario.Sprite('sprites/tiles_lulu.png', [160,144],[16,16],0)
    ],
    bushSprite: new Mario.Sprite('sprites/tiles_lulu.png', [176, 144], [48, 16], 0),
    bushSprites: [
     new Mario.Sprite('sprites/tiles_lulu.png', [176,144], [16,16],0),
     new Mario.Sprite('sprites/tiles_lulu.png', [192,144], [16,16],0),
     new Mario.Sprite('sprites/tiles_lulu.png', [208,144], [16,16],0)],
   ...
   flagPoleSprites: [
     new Mario.Sprite('sprites/tiles_lulu.png', [256, 128], [16,16], 0),
     new Mario.Sprite('sprites/tiles_lulu.png', [256, 144], [16,16], 0),
     new Mario.Sprite('sprites/items_lulu.png', [128, 32], [16,16], 0)
   ]
 });
